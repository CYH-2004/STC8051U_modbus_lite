...
//modbus_RTU 主机程序
extern uint8_t modbus_RTU_read_coils(uint8_t slave_addr, uint16_t reg_addr, uint16_t quantity, uint8_t *value, uint32_t timeout);               //(0x01) Read Coils
extern uint8_t modbus_RTU_read_discrete_input(uint8_t slave_addr, uint16_t reg_addr, uint16_t quantity, uint8_t *value, uint32_t timeout);      //(0x02) Read Discrete Inputs
extern uint8_t modbus_RTU_read_holding_regs(uint8_t slave_addr, uint16_t reg_addr, uint16_t quantity, uint16_t *RX_value_p, uint32_t timeout);  //(0x03) Read Holding Registers
extern uint8_t modbus_RTU_write_single_coil(uint8_t slave_addr, uint16_t reg_addr, uint16_t value, uint32_t timeout);                           //(0x05) Write Single Coil
extern uint8_t modbus_RTU_write_single_reg(uint8_t slave_addr, uint16_t reg_addr, uint16_t value, uint32_t timeout);                            //(0x06) Write Single Register    
extern uint8_t modbus_RTU_write_multi_coils(uint8_t slave_addr, uint16_t reg_addr, uint16_t quantity, uint8_t *Value_p, uint32_t timeout);      //(0x0F) Write Multiple Coils
extern uint8_t modbus_RTU_write_multi_regs(uint8_t slave_addr, uint16_t reg_addr, uint16_t quantity, uint16_t *Value_p, uint32_t timeout);      //(0x10) Write Multiple registers
